# DESIGN.md — UI/UX system for manuscript_editor
...
- **Favicon / logo:** derived from the manuscript_editor identity and
...
If manuscript_editor serves a web UI or ships as an app, this set exists before
